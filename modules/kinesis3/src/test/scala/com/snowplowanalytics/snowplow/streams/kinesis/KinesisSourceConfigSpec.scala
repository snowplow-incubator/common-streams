...
class KinesisSourceConfigSpec extends Specification {
  ...
  def e1 = {
    val json = json"""
    {
      ...
      "gracefulLeaseHandoffTimeout": "60 seconds",
      "leaseAssignmentInterval": "10 seconds",
  ...
  def e3 = {
    ...
    val expected = KinesisSourceConfig(
      ...
      gracefulLeaseHandoffTimeout      = 30.seconds,
      leaseAssignmentInterval          = 20.seconds,
  ...
  def e5 = {
    ...
    json.as[KinesisHttpSourceConfig] must beRight.like { case c: KinesisHttpSourceConfig =>
      List(
        ...
        c.kinesis.retrievalMode must beEqualTo(KinesisSourceConfig.Retrieval.Polling(42, 1500.millis)),

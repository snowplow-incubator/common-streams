...
object AtomicFields {
  private[loaders] val monetaryDecimal: Type.Decimal = Type.Decimal(DecimalPrecision.Digits18, 2)

  private[loaders] val schemaKey: SchemaKey = SchemaKey("com.snowplowanalytics.snowplow", "atomic", "jsonschema", SchemaVer.Full(1, 0, 0))
  ...
  val static: Vector[Field] =
    Vector(
      ...
      Field("tr_total", monetaryDecimal, Nullable),
      Field("tr_tax", monetaryDecimal, Nullable),
      Field("tr_shipping", monetaryDecimal, Nullable),
      ...
      Field("ti_price", monetaryDecimal, Nullable),
      ...
      Field("tr_total_base", monetaryDecimal, Nullable),
      Field("tr_tax_base", monetaryDecimal, Nullable),
      Field("tr_shipping_base", monetaryDecimal, Nullable),
      Field("ti_currency", Type.String, Nullable),
      Field("ti_price_base", monetaryDecimal, Nullable),
